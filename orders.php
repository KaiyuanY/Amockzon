...
$sql = "SELECT * FROM Orders WHERE user_id = $user_id ORDER BY order_time DESC";
$result = $db->query($sql);
...
<html lang="en">
  <head>
    ...
    <title>Amockzon - Order History</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="col-md-6">
            ...
            <tbody>
              <?php
                ...
                while($row = $result->fetch_array()){
                  ...
                  //$time = DateTime();
                  //$time->setTimestamp($row['order_time']);
          ...
          <?php
            echo "<p><strong>Total Money Spent</strong>: $$total_price ";
